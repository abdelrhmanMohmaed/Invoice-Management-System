            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-4">
                        <h1 class="text-2xl font-semibold text-gray-800">Modify Invoice NO:
                    ...
                    <form method="POST" action="{{ route('invoices.update', $invoice->id) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="invoice_number" name="invoice_number" type="text"
                                value="{{ $invoice->invoice_number }}" @class([
                        ...
                        <div>
                            ...
                            <select id="customer_id" name="customer_id" @class([
                                ...
                                @forelse ($customers as $item)
                                    <option value="{{ $item->id }}" @selected($invoice->customer_id == $item->id)>
                                        {{ $item->name }}
                                    </option>
                                @empty
                        ...
                        <div>
                            ...
                            <input id="date" name="date" type="date" value="{{ $invoice->date }}"
                                @class([
                                    'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500',
                                    'border-red-500 focus:border-red-500 focus:ring-red-500' => $errors->has(
                                        'date'),
